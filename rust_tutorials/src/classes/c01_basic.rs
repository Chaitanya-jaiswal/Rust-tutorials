...
// ANS: No, since by default it is private. In order to use it in the src/main.rs, we should make it public
//      by adding the `pub` keyword before the `const` keyword and import it in the main.rs by writing 
//      "use classes::c01_basic::_FALSE;"
